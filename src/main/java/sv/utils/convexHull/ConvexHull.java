...
public class ConvexHull extends FVector {
    public int dim;
    public ArrayList<Vertex> vertices = new ArrayList<Vertex>();
    public ArrayList<Simplex> simplexes = new ArrayList<Simplex>();
    ...
    Simplex[] initFaceDatabase(){
        ...
        for(int i = 0; i < dim + 1; i++){
            Vertex[] vertices_ = Utils.getNotIth(vertices, i).toArray(new Vertex[vertices.size() - 1]);//skips the i-th vertex. oppsite simplex
